...
------------Global SLAM------------
-- POSE_GRAPH.optimize_every_n_nodes = 20 -- Decrease
-- MAP_BUILDER.num_background_threads = 6 -- Increase up to number of cores
-- POSE_GRAPH.global_sampling_ratio = 0.003 -- Decrease
-- POSE_GRAPH.constraint_builder.sampling_ratio = 0.4 -- Decrease
POSE_GRAPH.constraint_builder.min_score = 0.8 -- Increase
-- POSE_GRAPH.global_constraint_search_after_n_seconds = 30 -- Increase
-- TRAJECTORY_BUILDER_2D.ceres_scan_matcher.ceres_solver_options.max_num_iterations = 3 -- Decrease
